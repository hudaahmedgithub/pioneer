 ...
 <div class="container">
                    <div class="program1-content">
                        <h2>برنامج حسابات ومخازن</h2>
                        <div class="row">
                            <div class="col-md-6 col-xs-12">
                                <p>برنامج حسابات Easy Store لإدارة كافة الأنشطة التجارية مثل ( المحلات – المخازن - الشركات التجارية - المعارض ) . يعتبربرنامج حسابات Easy Store يعتبر من أفضل البرامج المحاسبية فى الوطن العربي و ذلك لما يحتويه من قوائم متعددة
                                    لإدارة كافة الأقسام والأنشطة التجارية المختلفة، ودعم ضريبة القيمة المضافة VAT، ويساعدك برنامج محاسبة Easy Store على إدارة كافة الاقسام الأتية ( الاصناف - المخازن - المشتريات - المبيعات - الحسابات -الصيانة - الموظفين
                                    - التقارير - الاعدادات ) ، و يمكنك إصدار كافة التقارير والفواتير باللغة العربية من خلال برنامج حسابات ومخازن Easy Store . بالاضافة الى ربط الفروع ونقاط البيع على قاعدة بيانات واحدة من أى مكان حتى يمكنك متابعة كافة الفروع
                                    من خلال شاشة واحدة وإدارتها بكل سهولة ويسر.

                                </p>
                            </div>
                            <div class="col-md-6 col-xs-12">
                                <img src="{{asset('frontend/imgs/program__1.jpg')}}" alt="program1" />
                                <button><a href="#form">اطلب الآن!</a></button>
                            </div>
                        </div>
                        <div class="program1-details">
                            <h3>مميزات برنامج حسابات Easy Store </h3>
                            <div class="row">
                                <div class="col-md-6 col-xs-12">
                                    <img src="{{asset('frontend/imgs/program__1.jpg')}}" alt="program1" />
                                </div>
                            ...
                            <h3>قوائم برنامج حسابات Easy Store</h3>
